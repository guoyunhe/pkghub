...
export class RepoSchema extends BaseModel {
  static $columns = ['baseUrl', 'createdAt', 'distroId', 'enabled', 'id', 'keyFingerprint', 'keyUrl', 'lastSyncedAt', 'name', 'priority', 'repositoryFile', 'syncInterval', 'type', 'updatedAt'] as const
