 ...
 *
 * This starter uses Node.js scrypt under the hood. Node.js reference:
...
const hashConfig = defineConfig({
  ...
  list: {
    ...
    scrypt: drivers.scrypt({
      /**
       * Work factor (Node alias: N / cost). Higher values increase security and CPU+memory usage.
       *
       * Tuning guideline:
       *
       * - Start with 16384.
      ...
      /**
       * Block size (Node alias: r / blockSize). Increases memory and CPU linearly.
       *
       * Tuning guideline:
       *
      ...
      /**
       * Parallelization (Node alias: p / parallelization). Controls how many independent
      ...
      /**
       * Maximum memory limit in bytes (Node alias: maxmem / maxMemory). Hashing throws if the
       * estimated memory usage is above this limit. Node documents the check as approximately: 128 *
       * N * r > maxmem.
       *
       * Tuning guideline:
       *
